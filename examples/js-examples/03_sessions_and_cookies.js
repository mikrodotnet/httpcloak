...
async function main() {
  ...
  const session1 = new httpcloak.Session({ preset: "chrome-143" });
  ...
  const session2 = new httpcloak.Session({ preset: "chrome-143" });
  ...
  const session3 = new httpcloak.Session({ preset: "chrome-143" });
  ...
  const session4 = new httpcloak.Session({ preset: "chrome-143" });
